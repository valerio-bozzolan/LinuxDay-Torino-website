...
INSERT INTO `ldto_event` VALUES (221,'first-steps-with-gnu-linux','Primi passi con GNU/Linux','','50 minuti per sapere tutto ciò che serve per entrare nel mondo del software libero senza pentimento. Domande accette.','',NULL,'it','2019-10-26 14:00:00','2019-10-26 16:00:00','',0,14,31,1,1);
INSERT INTO `ldto_event` VALUES (222,'dont-touch-my-data','Don\'t Touch My Data','','Grazie a qualche volontario dimostreremo come ogni giorno la nostra privacy viene completamente compromessa, e come difendersi.\r\nPortate l\'amico «non ho niente da nascondere».','',NULL,'it','2019-10-26 15:00:00','2019-10-26 17:00:00','',0,14,31,1,1);
INSERT INTO `ldto_event` VALUES (223,'private-cloud','Private Cloud','','Raggiungere l\'indipendenza tecnologica è possibile. Tutti i servizi cloud che conosciamo possono essere sostituiti da un nostro computer.\r\nPronti, via!','',NULL,'','2019-10-26 16:00:00','2019-10-26 18:00:00','',0,14,31,1,1);
INSERT INTO `ldto_event` VALUES (224,'big-data','Eccovi il Big Data','','Chi parla di Big Data è come i pescatori: c\'è sempre chi  si inventerà la storia su quel tonno gigante. Quindi parleremo nel concreto delle tecnologie usate in ambito enterprise.','',NULL,'','2019-10-26 14:00:00','2019-10-26 16:00:00','',0,14,31,3,1);
INSERT INTO `ldto_event` VALUES (225,'go-programming-language','Il linguaggio Go','','In questi minuti sarete tutti convertiti al linguaggio di programmazione Go, quindi portatevi un dannato calcolatore per fare esperimenti.\r\nGo Go Go!','',NULL,'','2019-10-26 14:00:00','2019-10-26 16:00:00','',0,14,31,2,1);
INSERT INTO `ldto_event` VALUES (226,'arduino','Workshop Arduino','','Arduino è una piattaforma di prototipizzazione. Ma cosa diavolo significa?','',NULL,'it','2019-10-26 15:00:00','2019-10-26 17:00:00','',0,14,31,4,1);
INSERT INTO `ldto_event` VALUES (227,'offensive-security','From Zer0 t0 R00t','Offensive Security','Abbiamo poco tempo per simulare un ambiente vulnerabile e poter testare insieme, uno ad uno, le più famose tecniche di penetration testing.\r\nNon rifatelo a casa.','',NULL,'it','2019-10-26 14:00:00','2019-10-26 16:00:00','',0,14,31,4,1);
INSERT INTO `ldto_event` VALUES (228,'ansible','Ansible','','Vi mostrerò come automatizzare il processo di deploy di vari servizi grazie ai playbooks di Ansible.','',NULL,'','2019-10-26 15:00:00','2019-10-26 17:00:00','',0,14,31,3,1);
INSERT INTO `ldto_event` VALUES (229,'nivola','Nivola','Il cloud Piemontese','\r\n\r\nNivola è una piattaforma completamente open source che semplifica l\'utilizzo dei servizi cloud da parte della pubblica amministrazione. Ce ne parleranno alcuni autori dal CSI Piemonte.','',NULL,'it','2019-10-26 16:00:00','2019-10-26 18:00:00','',0,14,31,3,1);
INSERT INTO `ldto_event` VALUES (230,'read-the-docs','ReadTheDocs','','Un consulente per il Team per la Trasformazione Digitale del governo italiano parlerà di Docs Italia (https://docs.italia.it), una piattaforma Open Source per collezionare e condividere la documentazione della Pubblica Amministrazione.','Durante il 2018 sono stato un consulente per il Team per la Trasformazione Digitale del governo italiano per lavorare su Docs Italia (https://docs.italia.it), una piattaforma Open Source per collezionare e condividere la documentazione della Pubblica Amministrazione.\r\n\r\nNon abbiamo scritto Docs Italia da zero, ma lo abbiamo costruito sopra a Read The Docs: la piattaforma di riferimento la documentazione di pacchetti Python.\r\nQuesto ci ha permesso di risparmiare un bel po\' di lavoro! Ma il software Open Source non si scrive da solo e abbiamo fatto la nostra parte contribuendo a Read The Docs. In questo talk racconterò cosa abbiamo fatto e cosa abbiamo imparato.',NULL,'it','2019-10-26 15:00:00','2019-10-26 17:00:00','',0,14,32,2,1);
INSERT INTO `ldto_event` VALUES (232,'rust','Rust','','Vi parleremo di Rust, il linguaggio di programmazione sviluppato da Mozilla Research che ha influenzato C# 7, Elm, Idris e Swift.','',NULL,'it','2019-10-26 16:00:00','2019-10-26 18:00:00','',0,14,32,2,1);
INSERT INTO `ldto_event` VALUES (233,'mqtt','MQTT','','Che cos\'è l\'MQTT e che ruolo ha nelle nostre vite? Vi mostreremo gli utilizzi di questo protocollo di messaggistica.','',NULL,'','2019-10-26 16:00:00','2019-10-26 18:00:00','',0,14,34,4,1);
INSERT INTO `ldto_event` VALUES (234,'deep-speech','Deep Speech','Riconoscimento vocale','Come funziona una rete neurale per la decodifica della voce umana? E come contribuire? Lo scopriremo insieme ad una volontaria di Mozilla Foundation.','',NULL,'','2019-10-26 17:00:00','2019-10-26 19:00:00','',0,14,34,4,1);
INSERT INTO `ldto_event` VALUES (235,'apache-spark','Apache Spark','','Se avete mai sentito parlare di \"calcolo distribuito\", ora ve lo mostreremo, e si fa sul serio. Un sistemista ci mostrerà alcuni dettagli di questo strumento per il data analytics e machine learning algorithms.','',NULL,'','2019-10-26 17:00:00','2019-10-26 19:00:00','',0,14,33,3,1);
INSERT INTO `ldto_event` VALUES (236,'android','Android','','','',NULL,'','2019-10-26 17:00:00','2019-10-26 19:00:00','',0,14,32,2,1);
