...
# Last update: 2018-08-22T16:41:23+00:00
...
_("Il partecipanti saranno coinvolti in un sondaggio interattivo sugli utilizzi del software libero della vita di tutti i giorni. Si suggerisce di invitare il vostro classico conoscente scettico e/o fanboy (╯°□°)╯.");

// event[talk-base-4]::event_title
_("Linux al Comune di Torino");

// event[talk-dev-2]::event_title
_("Yocto Project, un generatore automatico di distribuzioni linux embedded");
...
_("Una introduzione ai sistemi distribuiti tramite la gestione dei container realizzati con Docker.
Una risposta alle domande: Docker a cosa serve? Come si installa? Come si gestisce?");

// event[talk-sys-4]::event_title
_("Hadoop - BigData in streaming");

// event[talk-sys-4]::event_description
_("Big Data, cosa sono e dove vanno? Use case di un cluster Hadoop per l'elaborazione in streaming con Apache NiFi, Kafka e Solr.");
...
_("Ebbene sì. Per la prima volta nelle edizioni torinesi del Linux Day, si è deciso di ospitare un CoderDojo, un po' particolare, dove i ninja si confronteranno con tematiche fondamentali, come il Software Libero e lo sviluppo Open Source. Entra a far parte della gang del Software Libero! =D<br>
<br>
