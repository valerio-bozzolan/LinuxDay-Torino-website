...
// skill[javaee]::skill_title
__("JavaEE");

// skill[jsf]::skill_title
__("JSF");

// skill[primefaces]::skill_title
__("PrimeFaces");

// skill[maven]::skill_title
__("Maven");

// skill[engineering]::skill_title
__("Engineering");

// skill[html]::skill_title
__("HTML");

// skill[css]::skill_title
__("CSS");

// skill[javascript]::skill_title
__("JavaScript");

// skill[artificial-intelligence]::skill_title
__("Artificial Intelligence");

// skill[machine-learning]::skill_title
__("Machine Learning");

// skill[mozilla]::skill_title
__("Mozilla");

// skill[effective-altruism]::skill_title
__("Effective Altruism");

// skill[python]::skill_title
__("Python");

// skill[data-science]::skill_title
__("Data Science");

// skill[jazz]::skill_title
__("Jazz");

// skill[lucid-dreaming]::skill_title
__("lucid dreaming");

// skill[berlin]::skill_title
__("Berlin");

// skill[london]::skill_title
__("London");

// skill[physics]::skill_title
__("physics");

// skill[phisics]::skill_title
__("phisics");

// skill[consciousness]::skill_title
__("consciousness");

// skill[vegan]::skill_title
__("vegan");

// skill[rust]::skill_title
__("Rust");

// skill[curiosity]::skill_title
__("Curiosity");

// skill[creativity]::skill_title
__("creativity");

// skill[teamwork]::skill_title
__("teamwork");

// skill[laziness]::skill_title
__("laziness");

// skill[linux]::skill_title
__("Linux");

// skill[big-data]::skill_title
__("Big Data");

// skill[kubernetes]::skill_title
__("Kubernetes");

// skill[devops]::skill_title
__("Devops");

// skill[azure]::skill_title
__("Azure");

// skill[developer]::skill_title
__("developer");
