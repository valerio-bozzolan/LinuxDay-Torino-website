...
CREATE TABLE `ldto_event` (
  ...
  `event_previous` int(10) unsigned DEFAULT NULL COMMENT 'event.event_ID',
  `event_next` int(10) unsigned DEFAULT NULL COMMENT 'event.event_ID',
  ...
  KEY `next_event_ID` (`event_previous`),
  KEY `previous_event_ID` (`event_next`),
  ...
  CONSTRAINT `ldto_event_ibfk_1` FOREIGN KEY (`event_next`) REFERENCES `ldto_event` (`event_ID`) ON DELETE SET NULL,
  CONSTRAINT `ldto_event_ibfk_2` FOREIGN KEY (`event_previous`) REFERENCES `ldto_event` (`event_ID`) ON DELETE SET NULL
...
-- Dump completed on 2016-11-21 13:57:07
